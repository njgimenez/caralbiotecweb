<?php $this->layout('admin::layout', ['title' => 'Configuración de Empresa | Admin', 'pageTitle' => 'Configuración de Empresa']) ?>
    ...
    <div class="col-12 col-lg-4">
        <div class="admin-form-card">
            ...
            <p class="text-muted mb-3" style="font-size:.9rem;line-height:1.6">
                Estos datos se imprimirán en boletas, facturas y reportes POS. El IGV configurado se usa para calcular el valor gravado e impuesto incluido en el total de venta.
            </p>
